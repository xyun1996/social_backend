...
- Generated bindings live beside the contract tree but in versioned Go package directories, so hand-written service code can import them without sharing directories with `.proto` sources.
